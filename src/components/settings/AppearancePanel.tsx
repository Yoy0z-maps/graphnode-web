...
const themes = [
  ...
  { key: "light", value: "settings.appearance.theme.light" },
  { key: "dark", value: "settings.appearance.theme.dark" },
] as const;
  ...
  return (
    <SettingsPanelLayout>
        ...
        {themes.map((themeOption) => (
          ...
          >
            <input
              ...
              onChange={() => setTheme(themeOption.key)}
              className="hidden"
            />
            <div
      ...
      <SettingCategoryTitle
        ...
        subtitle={t("settings.appearance.editor.subTitle")}
      />
